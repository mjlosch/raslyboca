...
#    m2.fillcontinents(color='k',lake_color='g',alpha=0.1)
    ...
    vmin,vmax=-.1,.1
    for im in cb.flatten([lh1,lh2,lh3]): im.set_clim(vmin,vmax)


#for im in lh1: im.set_clim(-.1,.1)
#for im in lh2: im.set_clim(-.1,.1)
#for im in lh3: im.set_clim(-.1,.1)
